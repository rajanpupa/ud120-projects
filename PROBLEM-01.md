...
Before reaching to this problem, we learnt about the "Niave Bayes" algorithm that gives us probability about who might a combination of text belongs to, provided the probability of the usage of words by the person.

### Required
- python 2.7
- go to the tools folder and run startup.py
